...
from .views import cart_add, cart_dell, cart_update, cart_view
...
class CartAddViewTestCase(TestCase):
    ...
    def test_cart_add(self):
        ...
        self.assertEqual(data['product_qty'], 2)
...
class CartDeleteViewTestCase(TestCase):
    ...
    def test_cart_dell(self):
        request = self.factory
        response = cart_dell(request)
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.content)
        self.assertEqual(data['product_qty'], 0)
...
class CartUpdateViewTestCase(TestCase):
    ...
    def test_cart_update(self):
        ...
        self.assertEqual(data['product_qty'], 5)