...
class ProductViewTest(TestCase):
    def test_get_products(self):
        ...
        product_1 = Product.objects.create(title='Product 1',  category=category, image=uploaded, slug='proudct-1')
        product_2 = Product.objects.create(title='Product 2',  category=category, image=uploaded, slug='proudct-2')
