...
class ShippingAddress(models.Model):
    ...
    def create_default_shipping_address(cls, user):
        defaul_shipping_address = {"user": user, "full_name": "Noname", "email": "example@example.com",
                                   "street_address": "fill address", "apartment_address": "fill address", "country": ""}
        shipping_address = cls(**defaul_shipping_address)
    ...
    class Meta:
        ...
        constraints =[
            models.CheckConstraint(
                check=models.Q(discount__gte=0) , name='amount_gte_0'),
        ]
    def __str__(self):
